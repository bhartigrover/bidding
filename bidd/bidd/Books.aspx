<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Books.aspx.cs" Inherits="bidd.Books" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table border="1" >
        <tr >
            <td>
                <h1>Product Name</h1>
                <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/Book1.jpg" />
                <br />
         ...
         &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
           <asp:ImageButton ID="ImageButton6" runat="server" ImageUrl="~/Images/Buy.png" />
            ...
            <td>
                <h1>Product Name</h1>
                <asp:Image ID="Image2" runat="server" ImageUrl="~/Images/Book2.jpg" />
                <br />
         ...
         &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
           <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Images/Buy.png" />
            ...
            <td class="auto-style1">
                <h1>Product Name</h1>
                <asp:Image ID="Image3" runat="server" ImageUrl="~/Images/Book3.jpg" Width="127px" />
                <br />
        ...
        <tr >
            <td>
                <h1>Product Name</h1>
                <asp:Image ID="Image4" runat="server" ImageUrl="~/Images/Book4.jpg" />
                <br />
         ...
         &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
           <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Images/Buy.png" />
            ...
            <td>
                <h1>Product Name</h1>
                <asp:Image ID="Image5" runat="server" ImageUrl="~/Images/Book5.jpg" />
                <br />
         ...
         &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
           <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/Images/Buy.png" />
            ...
            <td class="auto-style1">
                <h1>Product Name</h1>
                <asp:Image ID="Image6" runat="server" ImageUrl="~/Images/Book6.jpg" />
                <br />
        ...
        <tr >
            <td>
                <h1>Product Name</h1>
                <asp:Image ID="Image7" runat="server" ImageUrl="~/Images/Book7.jpg" />
                <br />
                <asp:Label ID="Label7" runat="server" Text="MRP:12000"></asp:Label><br />              
         &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
           <asp:ImageButton ID="ImageButton7" runat="server" ImageUrl="~/Images/Buy.png" />
            ...
            <td>
                <h1>Product Name</h1>
                <asp:Image ID="Image8" runat="server"  ImageUrl="~/Images/Book8.jpg"/>
                <br />
                <asp:Label ID="Label8" runat="server" Text="MRP:12000"></asp:Label><br />              
         &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
           <asp:ImageButton ID="ImageButton8" runat="server" ImageUrl="~/Images/Buy.png" />
