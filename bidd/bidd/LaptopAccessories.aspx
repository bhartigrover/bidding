<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="LaptopAccessories.aspx.cs" Inherits="bidd.LaptopAccessories" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table border="1">
        <tr>
            ...
            <td>
                <h1>Product Name</h1>
                <asp:Image ID="Image1" runat="server"  ImageUrl="~/Images/Dell1.jpg"/>
                <br />
         ...
         &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
           <asp:ImageButton ID="ImageButton6" runat="server" ImageUrl="~/Images/Buy.png" />
            ...
            <td>
                <h1>Product Name</h1>
                <asp:Image ID="Image2" runat="server"  ImageUrl="~/Images/Dell2.jpg"/>
                <br />
         ...
         &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
           <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Images/Buy.png" />
            ...
            <td>
                <h1>Product Name</h1>
                <asp:Image ID="Image3" runat="server" ImageUrl="~/Images/dell3.jpg"/>
                <br />
        ...
        <tr>
            <td>
                <h1>Product Name</h1>
                <asp:Image ID="Image4" runat="server" ImageUrl="~/Images/dell4.jpg"/>
                <br />
         ...
         &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
           <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Images/Buy.png" />
            ...
            <td>
                <h1>Product Name</h1>
                <asp:Image ID="Image5" runat="server" ImageUrl="~/Images/Dell5.jpg"/>
                <br />
